...
{    
  ...
  public static var fontPath:String = "assets/fonts/vcr.ttf";
    ...
    * 
    * Example: Paths.getLibraryPath("images/Macho.png")
    */
    ...
    */
    ...
    public static var textArray:Array<String> = [
        ...
        "Thank you Firubii for the notification code :)",
         "Alarum  is not real it cant hurt you meanwhile alarum: *&^*^#@&*"
    ];
}
...
class GameJoltLogin extends MusicBeatSubstate
{
    ...
    override function create()
    {
        ...
        var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('BG3', 'preload'));
        ...
        funnyText = new FlxText(5, FlxG.height - 40, 0, GameJoltInfo.textArray[FlxG.random.int(0, GameJoltInfo.textArray.length - 1)]+ " -Macho", 12);
        add(funnyText);
        ...
        usernameText = new FlxText(0, 125, 300, "GameJolt user:", 20);
        ...
        usernameBox = new FlxUIInputText(0, 175, 300, null, 32, FlxColor.BLACK, FlxColor.BLUE);
        tokenBox = new FlxUIInputText(0, 275, 300, null, 32, FlxColor.BLACK, FlxColor.RED);
