...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["You really did it",				"Beat Week M on Hard with no Misses",		'weekM_nomiss',				false],
		["Macho Is VERY shcoked",				"Beat Week M on Crazy+ with no Misses",		'weekM_nomissC',				true],
		["Cool",				"FC week M",		'WeekMfc',				true]
	];
